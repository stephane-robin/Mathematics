...
for t in range(0,5*periode) :
    ...
    list_y1 = [] # Création d'une liste vide pour y stocker les ordonnées des points
    list_y2 = [] # Création d'une liste vide pour y stocker les ordonnées des points
    list_y3 = [] # Création d'une liste vide pour y stocker les ordonnées des points
    ...
    pyplot.title("Propagation d'une onde sinusoïdale le long d'une corde") # Donne un titre à l'animation
    pyplot.plot(list_x, list_y1, c = 'blue', marker = ',')
    pyplot.plot(list_x, list_y2, c = 'red', marker = ',')
    pyplot.plot(list_x, list_y3, c = 'green', marker = ',')
    pyplot.pause(0.001)
